(module
  ...
  (func $~lib/rt/__newArray (type 3) (param i32 i32 i32) (result i32)
    ...
    i32.store offset=12
    local.get 1)
  (func $start:tests/transfer-between-users.test~anonymous|0~anonymous|0 (type 4)
  ...
  (func $tests/helpers/createTransferEvent (type 3) (param i32 i32 i32) (result i32)
  ...
  (func $src/nonfungible-position-manager/handleTransfer (type 8) (param i32)
    ...
    local.get 3
    call $src/nonfungible-position-manager/createPositionEvent)
  (func $tests/helpers/getExpectedEventId (type 0) (param i32) (result i32)
    i32.const 12288
    i32.const 11248
    call $~lib/string/String#concat
    i32.const 12400
    ...
    i32.const 12240
    call $~lib/string/String#concat)
  (func $start:tests/transfer-between-users.test~anonymous|0~anonymous|1 (type 4)
    (local i32 i32 i32 i32)
    i32.const 1001
    call $~lib/@graphprotocol/graph-ts/common/collections/ByteArray.fromI32
    local.set 0
    ...
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.bigIntToString
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/transfer-between-users.test~anonymous|0~anonymous|2 (type 4)
    (local i32 i32)
    i32.const 1002
    call $~lib/@graphprotocol/graph-ts/common/collections/ByteArray.fromI32
    local.set 0
    ...
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.bigIntToString
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/transfer-between-users.test~anonymous|0~anonymous|3 (type 4)
    (local i32)
    i32.const 9999
    call $~lib/@graphprotocol/graph-ts/common/collections/ByteArray.fromI32
    local.set 0
    ...
    call $~lib/builtins/abort
    unreachable)
  (func $start:tests/transfer-between-users.test~anonymous|0 (type 4)
    i32.const 3840
    i32.load
    i32.const 3872
  ...
  (elem $0 (i32.const 1) func $start:tests/transfer-between-users.test~anonymous|0~anonymous|0 $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/transfer-between-users.test~anonymous|0~anonymous|1 $start:tests/transfer-between-users.test~anonymous|0~anonymous|2 $start:tests/transfer-between-users.test~anonymous|0~anonymous|3 $start:tests/transfer-between-users.test~anonymous|0)
