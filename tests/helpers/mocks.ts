...
// Mock contract calls
export function mockOwnerOfCall(contractAddress: Address, tokenId: BigInt, owner: Address): void {
...
export function mockPositionsCall(contractAddress: Address, tokenId: BigInt, token0: Address, token1: Address, fee: BigInt): void {
...
export function mockGetPoolCall(factoryAddress: Address, token0: Address, token1: Address, fee: BigInt, poolAddress: Address): void {
  createMockedFunction(factoryAddress, "getPool", "getPool(address,address,uint24):(address)")
    .withArgs([
...
export function setupTrackedPoolMocks(contractAddress: Address, tokenId: BigInt, owner: Address): void {
...
export function setupTrackedPool2Mocks(contractAddress: Address, tokenId: BigInt, owner: Address): void {
  mockOwnerOfCall(contractAddress, tokenId, owner)
  mockPositionsCall(contractAddress, tokenId, TOKEN0_POOL2, TOKEN1_POOL2, FEE_POOL2)
  mockFactoryCall(contractAddress)
  mockGetPoolCall(FACTORY_ADDRESS, TOKEN0_POOL2, TOKEN1_POOL2, FEE_POOL2, TRACKED_POOL_2)
}

export function setupUntrackedPoolMocks(contractAddress: Address, tokenId: BigInt, owner: Address): void {
  mockOwnerOfCall(contractAddress, tokenId, owner)
  mockPositionsCall(contractAddress, tokenId, TOKEN0, TOKEN1, FEE)
  mockFactoryCall(contractAddress)
