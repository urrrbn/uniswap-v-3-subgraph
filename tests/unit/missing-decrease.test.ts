...
describe("Missing Decrease Handling", () => {
  ...
  test("missing_decrease_is_ignored", () => {
    ...
    let missingTokenId = BigInt.fromI32(3001)
    ...
    let decreaseEvent = createDecreaseLiquidityEvent(missingTokenId, liquidity, amount0, amount1)
    ...
    let eventId = getExpectedEventId(missingTokenId, "DECREASE")
  ...
  test("missing_decrease_untracked_pool_is_ignored", () => {
    ...
    let missingTokenId = BigInt.fromI32(3002)
    let liquidity = BigInt.fromI32(500)
    let amount0 = BigInt.fromI32(50)
    let amount1 = BigInt.fromI32(100)
  ...
  test("missing_decrease_after_valid_position_exists_elsewhere", () => {
    ...
    let missingTokenId = BigInt.fromI32(3004)
    ...
    let decreaseEvent = createDecreaseLiquidityEvent(missingTokenId, liquidity, BigInt.fromI32(100), BigInt.fromI32(200))
    handleDecreaseLiquidity(decreaseEvent)
  ...
  test("multiple_missing_decreases_all_ignored", () => {
    ...
    let missing1 = BigInt.fromI32(3005)
    let missing2 = BigInt.fromI32(3006)
    let missing3 = BigInt.fromI32(3007)
    ...
    handleDecreaseLiquidity(createDecreaseLiquidityEvent(missing1, BigInt.fromI32(100), BigInt.fromI32(10), BigInt.fromI32(20)))
    handleDecreaseLiquidity(createDecreaseLiquidityEvent(missing2, BigInt.fromI32(200), BigInt.fromI32(20), BigInt.fromI32(40)))
    handleDecreaseLiquidity(createDecreaseLiquidityEvent(missing3, BigInt.fromI32(300), BigInt.fromI32(30), BigInt.fromI32(60)))
